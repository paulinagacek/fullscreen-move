...
export default defineConfig({
    plugins,
    server: {
        // Fallback to 2137, if PORT is not specified in .env
        port: PORT || 2137,
        headers: {
            "Permissions-Policy": "fullscreen=(self), automatic-fullscreen=(self), window-management=(self), display-capture=(self), direct-sockets=(self), cross-origin-isolated=(self)",
        },
        hmr: {
            protocol: "ws",
            host: "localhost",
            clientPort: PORT || 2137,
        },
    },
